...
# FINAL full grid for Energy. Single frozen PROCEED (no MoE/guard).
# Decided on validation corners: capacity=full (cdim200/bneck32), lr=0.000001, ema=0.
...
data=Energy; freq=10min; cdim=200; bneck=32; lr=0.000001
