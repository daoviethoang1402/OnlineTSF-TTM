...
# FINAL full grid for Jiaolong_DSMS. Single frozen PROCEED (no MoE/guard).
# Decided on validation corners: capacity=reduced (cdim64/bneck8), lr=0.000001, ema=0.
...
data=Jiaolong_DSMS; freq=s; cdim=64; bneck=8; lr=0.000001
for seq_len in 512 1024 1536
do
for pred_len in 96 192 336 720
do
    fn=logs/capacity-final/${data}_${seq_len}_${pred_len}_reduced_lr${lr}.log
    echo "[capfinal] data=$data seq=$seq_len pred=$pred_len cap=reduced lr=$lr"
