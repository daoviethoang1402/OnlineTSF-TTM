...
# ---------------------------------------------------------------------------
# reg_combo2 full-grid run (frozen PROCEED + TTM), AirQuality (UCI gas-sensor drift, out-of-corpus,
# non-stationary; sensor aging = real concept drift).
#
...
# 9.5k rows -> pred 720 dropped (val split too small, like Exchange).
