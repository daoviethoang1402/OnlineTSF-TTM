...
# ---------------------------------------------------------------------------
# reg_combo2 full-grid run (frozen PROCEED + TTM), Energy (appliances, out-of-corpus,
# non-stationary; headroom-study candidate).
#
...
# 20k rows -> full grid (all pred incl 720) fits.
